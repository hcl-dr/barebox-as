...
extern char __dtb_z_dr_simpad2p_revA_start[];
extern char __dtb_z_dr_simpad2p_revB_start[];
extern char __dtb_z_dr_simpad2p_revC_start[];
...
static int get_hwrev(void)
{
	...
	imx8mp_setup_pad(MX8MP_PAD_SAI3_MCLK__GPIO5_IO02 | INPUT_NOPULL_CTRL);
	imx8mp_setup_pad(MX8MP_PAD_SAI3_RXFS__GPIO4_IO28 | INPUT_NOPULL_CTRL);
	imx8mp_setup_pad(MX8MP_PAD_SAI3_RXC__GPIO4_IO29 | INPUT_NOPULL_CTRL);
	imx8m_gpio_direction_input(gpiobase5, 2);
	imx8m_gpio_direction_input(gpiobase4, 28);
	imx8m_gpio_direction_input(gpiobase4, 29);

	ver |= imx8m_gpio_val(gpiobase5, 2);
	ver |= imx8m_gpio_val(gpiobase4, 28) << 1;
	ver |= imx8m_gpio_val(gpiobase4, 29) << 2;
