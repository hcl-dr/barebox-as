...
extern char __dtb_z_dr_imx8mp_evk_start[];
...
#ifdef CONFIG_DR_IMX8MP_EVK_VDD_SOC_085
...
extern struct dram_timing_info dr_imx8mp_evk_dram_timing;
...
static void start_atf(void)
{
	...
	power_init_board();
	printf("Init DDR\n");
	imx8mp_ddr_init(&dr_imx8mp_evk_dram_timing, DRAM_TYPE_LPDDR4);
 ...
 */
static __noreturn noinline void dr_imx8mp_evk_start(void)
{
	setup_uart();
	 ...
	 */
	imx8mp_barebox_entry(__dtb_z_dr_imx8mp_evk_start);
}

ENTRY_FUNCTION(start_dr_imx8mp_evk, r0, r1, r2)
{
