...
extern char __dtb_z_as_imx8mp_evk_start[];
...
static void start_atf(void)
{
	...
	imx8mp_ddr_init(&as_imx8mp_evk_dram_timing, DRAM_TYPE_LPDDR4);

	imx8mp_load_and_start_image_via_tfa();
}

/*
 * Power-on execution flow of start_as_imx8mp_evk() might not be
 ...
 */
static __noreturn noinline void as_imx8mp_evk_start(void)
{
	setup_uart();
	 ...
	 */
	imx8mp_barebox_entry(__dtb_z_as_imx8mp_evk_start);
}

ENTRY_FUNCTION(start_as_imx8mp_evk, r0, r1, r2)
{
